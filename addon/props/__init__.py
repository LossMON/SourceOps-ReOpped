...
def register():
    ...
    bpy.utils.register_class(SOURCEOPS_MaterialProps)
    bpy.utils.register_class(SOURCEOPS_MaterialFolderProps)
    bpy.utils.register_class(SOURCEOPS_ModelFolderProps)
...
def unregister():
    ...
    bpy.utils.unregister_class(SOURCEOPS_ModelFolderProps)
    bpy.utils.unregister_class(SOURCEOPS_MaterialFolderProps)
    bpy.utils.unregister_class(SOURCEOPS_MaterialProps)
