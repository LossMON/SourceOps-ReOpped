...
class SOURCEOPS_GameProps(bpy.types.PropertyGroup):
    name: bpy.props.StringProperty(
        ...
        default='Example',
        update=utils.game.trigger_backup
    )
    ...
    hlmvplusplus: bpy.props.StringProperty(
        name='HLMV++',
        description='Path to your HLMV++ bin folder, hlmvplusplus.exe is here',
        subtype='DIR_PATH',
        update=utils.game.update_hlmvplusplus,
    )
