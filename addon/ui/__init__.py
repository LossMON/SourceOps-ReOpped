...
from . lists import SOURCEOPS_UL_ModelFolderList
from . lists import SOURCEOPS_UL_MaterialList
...
def register():
    ...
    bpy.utils.register_class(SOURCEOPS_UL_ModelFolderList)
    bpy.utils.register_class(SOURCEOPS_UL_MaterialFolderList)
    bpy.utils.register_class(SOURCEOPS_UL_MaterialList)
...
def unregister():
    ...
    bpy.utils.unregister_class(SOURCEOPS_UL_MaterialList)
    bpy.utils.unregister_class(SOURCEOPS_UL_MaterialFolderList)
    bpy.utils.unregister_class(SOURCEOPS_UL_ModelFolderList)
